---
name: sd-adopt
description: Onboard an existing repository into the system-design workflow — survey it, draft seed proposed ADRs documenting the current architecture (governing the most-changed files), and hand them to /sd:decide for ratification. Never auto-accepts. Use for /sd:adopt.
---

# sd-adopt — onboard an existing repo
