---
name: sd-spec
description: Write or refine the SPEC for a request, resolving every open question (gate G1), then advance to SPECCED. Handles the TRIVIAL fast-path (CHANGELOG-only to DONE). Use for /sd:spec.
---

# sd-spec — the SPEC phase (gate G1)
