---
name: sd-override
description: Grant an audited, scoped exception to the edit gate when the workflow is genuinely blocking legitimate work. Use for /sd:override.
---

# sd-override — the audited escape hatch
